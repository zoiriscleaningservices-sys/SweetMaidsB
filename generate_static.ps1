...
<head>
  ...
  <style>
    ...
    .hyper-scroller-content {
        display: flex;
        animation: hyperDrive 30s linear infinite;
    }
    ...
    *:not(i) { font-family: 'Outfit', sans-serif; }
    ...
    @media (max-width: 1024px) {
        ...
        .card-hero { order: 2; }
        .card-gallery { order: 3; }
        .card-expertise { order: 4; }
        .card-contact { order: 5; }
        .card-social { order: 6; }
        .card-related { order: 7; }
...
<body>
  <!-- Hyper-Drive Infinite Scroller (Global Rollout) -->
  <div class="hyper-scroller" onclick="window.location.href='https://truewebx.site/rollout.html'">
      <div class="hyper-scroller-content">
          <span class="hyper-text">TRUEWEBX <b>GLOBAL ROLLOUT</b> <i>//</i> ZADAPT SYSTEMS <b>ADAPTIVE TECH</b> <i>//</i> LIMPIEZA DIGITAL <b>PERFORMANCE ENGINE</b> <i>//</i> REAL-TIME <b>RANKING SUPREMACY</b> <i>//</i> GOING <b>WORLDWIDE</b> <i>//</i> </span>
          <span class="hyper-text">TRUEWEBX <b>GLOBAL ROLLOUT</b> <i>//</i> ZADAPT SYSTEMS <b>ADAPTIVE TECH</b> <i>//</i> LIMPIEZA DIGITAL <b>PERFORMANCE ENGINE</b> <i>//</i> REAL-TIME <b>RANKING SUPREMACY</b> <i>//</i> GOING <b>WORLDWIDE</b> <i>//</i> </span>
          <span class="hyper-text">TRUEWEBX <b>GLOBAL ROLLOUT</b> <i>//</i> ZADAPT SYSTEMS <b>ADAPTIVE TECH</b> <i>//</i> LIMPIEZA DIGITAL <b>PERFORMANCE ENGINE</b> <i>//</i> REAL-TIME <b>RANKING SUPREMACY</b> <i>//</i> GOING <b>WORLDWIDE</b> <i>//</i> </span>
          <span class="hyper-text">TRUEWEBX <b>GLOBAL ROLLOUT</b> <i>//</i> ZADAPT SYSTEMS <b>ADAPTIVE TECH</b> <i>//</i> LIMPIEZA DIGITAL <b>PERFORMANCE ENGINE</b> <i>//</i> REAL-TIME <b>RANKING SUPREMACY</b> <i>//</i> GOING <b>WORLDWIDE</b> <i>//</i> </span>
      </div>
  ...
  <header class="header-wrapper" id="header">
    <a href="../../index.html" class="logo" aria-label="TrueWebX Home">
        <img src="../../favicon/TrueWebX.jpeg" alt="TrueWebX Logo">
    </a>
  ...
  <nav class="nav-dock">
    ...
    <a href="../../index.html#list" class="nav-item"><i class="fas fa-compass"></i> Discover</a>
    <a href="../../dashboard.html" class="nav-item"><i class="fas fa-user-circle"></i> Account</a>
  </nav>
