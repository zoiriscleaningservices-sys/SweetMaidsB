...
$content = $content -replace '(?s)<title>.*?</title>', '<title>#1 Rated Cleaning Service In Your Area | Sweet Maid Cleaning</title>'
$content = $content -replace '(?s)<meta property="og:title" content="[^"]*">', '<meta property="og:title" content="#1 Rated Cleaning Service In Your Area | Sweet Maid Cleaning">'
...
$content = $content -replace '(?s)<meta name="description"\s+content="[^"]*"', "<meta name=`"description`"`r`n    content=`"$desc`""
...
$content = $content -replace '(?s)<meta name="keywords"\s+content="[^"]*"', "<meta name=`"keywords`"`r`n    content=`"$keywords`""
...
$content = $content -replace '(?s)<!-- Areas Section -->.*?<\/section>', $locationsHtml

[System.IO.File]::WriteAllText($filePath, $content, (New-Object System.Text.UTF8Encoding $false))

Write-Host "New index.html has been generated."
