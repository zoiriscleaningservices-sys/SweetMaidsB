...
foreach ($file in $files) {
  ...
  <script type="application/ld+json">
  {
    ...
    "name": "Sweet Maid Cleaning Service - Best $serviceName in $location FL",
    "description": "Looking for the best $serviceName in $location FL? Sweet Maid provides top-rated $location $serviceName. We are the premier choice for $serviceName $location fl.",
    ...
    "makesOffer": [
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "$serviceName in $location FL"
        }
      },
      {
        "@type": "Offer",
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "Who provides the best $serviceName $location fl?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sweet Maid Cleaning is widely recognized as providing the best $location $serviceName. We guarantee satisfaction on all our $serviceName in $location fl."
        }
      }
    ]
  }
      ...
      <section class="py-12 bg-white border-t border-pink-50">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-gray-600 leading-relaxed mb-4">
                As the leading provider of <strong>$serviceName in $location fl</strong> and the surrounding areas, Sweet Maid is dedicated to maintaining the highest cleanliness standards for your property. Whether you are looking for <strong>$serviceName $location fl</strong> or the best <strong>$location $serviceName</strong>, our licensed and insured team is always nearby and ready to help. We understand the specific needs of $location residents and business owners and tailor our approach to deliver a reliable, spotless result every single time for anyone needing <strong>$serviceName in $location fl</strong>.
            </p>
            <p class="text-gray-600 leading-relaxed">
                Don't settle for less when it comes to the hygiene and appearance of your space in $location, FL. Join countless satisfied locals who rely on our trusted professional cleaners. <a href="#quote" class="text-pink-500 font-semibold hover:text-pink-600 underline">Get your free $location $serviceName quote today!</a>
            </p>
        </div>
      </section>
...
"@
  ...
  $content = [regex]::Replace($content, '(?si)<!-- HYPER-LOCAL SEO BLOCK V2 -->.*?<!-- END HYPER-LOCAL SEO BLOCK V2 -->', "")
