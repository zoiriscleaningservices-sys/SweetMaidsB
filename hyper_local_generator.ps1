...
$serviceH1Map = @{
    ...
    "home-watch-services"               = "Professional Home Watch Services in {LOCATION}, FL"
    "office-janitorial-services"        = "Expert Office Janitorial Services in {LOCATION}, FL"
    "janitorial-cleaning-services"      = "Premium Janitorial Cleaning Services in {LOCATION}, FL"
    "medical-dental-facility-cleaning"  = "Medical & Dental Facility Cleaning in {LOCATION}, FL"
    "industrial-warehouse-cleaning"     = "Industrial & Warehouse Cleaning in {LOCATION}, FL"
    "floor-stripping-waxing"            = "Floor Stripping & Waxing Services in {LOCATION}, FL"
    "gym-fitness-center-cleaning"       = "Gym & Fitness Center Cleaning in {LOCATION}, FL"
    "school-daycare-cleaning"           = "School & Daycare Cleaning Services in {LOCATION}, FL"
    "church-worship-center-cleaning"    = "Church & Worship Center Cleaning in {LOCATION}, FL"
    "property-management-janitorial"    = "Property Management Janitorial in {LOCATION}, FL"
    "luxury-estate-cleaning"            = "Luxury Estate Cleaning Services in {LOCATION}, FL"
    "solar-panel-cleaning"              = "Professional Solar Panel Cleaning in {LOCATION}, FL"
    "gutter-cleaning"                   = "Expert Gutter Cleaning Services in {LOCATION}, FL"
    "property-maintenance"              = "Professional Property Maintenance in {LOCATION}, FL"
    "airbnb-vacation-rental-management" = "Airbnb & Vacation Rental Management in {LOCATION}, FL"
    "luxury-estate-management"          = "Luxury Estate Management Services in {LOCATION}, FL"
}
...
$serviceDescMap = @{
    ...
    "home-watch-services"               = "Trusted home watch services in {LOCATION}, FL. We protect your home while you're away with regular inspections."
    "office-janitorial-services"        = "Customized office janitorial services for a clean, productive workspace in {LOCATION}, FL. Licensed & Insured."
    "janitorial-cleaning-services"      = "Professional janitorial cleaning services for businesses of all sizes in {LOCATION}. Quality you can trust."
    "medical-dental-facility-cleaning"  = "Specialized cleaning for medical and dental facilities in {LOCATION}, FL. Meeting all sanitation standards."
    "industrial-warehouse-cleaning"     = "Heavy-duty industrial and warehouse cleaning services in {LOCATION}. Keeping your facility safe and clean."
    "floor-stripping-waxing"            = "Expert floor stripping and waxing to revitalize your commercial floors in {LOCATION}, FL."
    "gym-fitness-center-cleaning"       = "Keep your gym or fitness center sanitized and safe for members in {LOCATION} with our expert cleaning."
    "school-daycare-cleaning"           = "Safe, non-toxic cleaning for schools and daycare centers in {LOCATION}, FL. Protecting our children."
    "church-worship-center-cleaning"    = "Respectful and thorough cleaning services for churches and worship centers in {LOCATION}, FL."
    "property-management-janitorial"    = "Comprehensive janitorial services for property managers in {LOCATION}. we keep your tenants happy."
    "luxury-estate-cleaning"            = "Discreet, high-end cleaning services for luxury estates in {LOCATION}, FL. Meticulous attention to detail."
    "solar-panel-cleaning"              = "Maximize your solar efficiency with professional solar panel cleaning in {LOCATION}, FL."
    "gutter-cleaning"                   = "Professional gutter cleaning to protect your {LOCATION} home from water damage. Fast & Affordable."
    "property-maintenance"              = "Reliable property maintenance services in {LOCATION}, FL. Keeping your property in peak condition."
    "airbnb-vacation-rental-management" = "Complete Airbnb and vacation rental management in {LOCATION}. Cleaning, maintenance, and more."
    "luxury-estate-management"          = "Premier management services for luxury estates in {LOCATION}, FL. Peace of mind for homeowners."
}
...
foreach ($loc in $locations) {
    ...
    foreach ($svc in $services) {
        ...
        if (Test-Path $sourceFile) {
            ...
            # Fix Local Navigation Linking (Global to Silo)
            $content = $content -replace '<a href="#" onclick="window.scrollTo\(\{top: 0, behavior: ''smooth''\}\); return false;"(.*?>Home</a>)', "<a href=`"/$locSlug/`"`$1"
            $content = $content -replace '<a href="#" onclick="window.scrollTo\(\{top: 0, behavior: ''smooth''\}\); return false;"(.*?>\s*(?:<span.*?>)?Home(?:</span>)?\s*<i.*?>.*?)</a>', "<a href=`"/$locSlug/`"`$1</a>"
            ...
            $content = $content -replace '(?s)<title>.*?</title>', "<title>Best $svcName in $cleanLoc FL | $cleanLoc $svcName</title>"
            $content = $content -replace '(?s)<meta name="description".*?>', "<meta name=""description"" content=""Need the best $svcName in $cleanLoc FL? Sweet Maid offers expert $cleanLoc $svcName. Licensed & Insured. 100% Guaranteed. Get a Quote!"" />"
...
"@)
            ...
            # SEO Hero Description with Exact Matches
            $seoDesc = if ($serviceDescMap.ContainsKey($svcSlug)) { $serviceDescMap[$svcSlug] -replace '\{LOCATION\}', $cleanLoc } else { "Expert $svcName in $cleanLoc FL. 100% Satisfaction Guaranteed." }
            ...
            <p class="text-xl text-gray-600 mb-10 max-w-lg leading-relaxed">
                $seoDesc Looking for top-rated <strong>$cleanLoc $svcName</strong>? We are the premier choice for <strong>$svcName in $cleanLoc fl</strong>.
            </p>
"@)
